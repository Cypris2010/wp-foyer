...
/**
 * Adds admin functionality for the Text (Blocks) slide format.
 *
 * Uses Gutenberg for the content area (post_content). Pretitle/Title/Subtitle/QR
 * are managed as meta fields similarly to the classic Text format.
 *
 * @since	1.8.1
 *
 * @package	Foyer
 ...
 */
class Foyer_Admin_Slide_Format_Text_Blocks {

    /**
     * Saves additional data for the Text (Blocks) slide format.
     *
     * @since	1.8.1
     *
    ...
    static function save_slide( $post_id ) {
        $slide_text_pretitle = isset( $_POST['slide_text_pretitle'] ) ? sanitize_text_field( $_POST['slide_text_pretitle'] ) : '';
        $slide_text_title    = isset( $_POST['slide_text_title'] ) ? sanitize_text_field( $_POST['slide_text_title'] ) : '';
        $slide_text_subtitle = isset( $_POST['slide_text_subtitle'] ) ? sanitize_text_field( $_POST['slide_text_subtitle'] ) : '';
        ...
        // Maintain QR SVG cache/hash like in Text slide
    ...
    /**
     * Outputs the meta box for the Text (Blocks) slide format.
     *
     * Note: No Content textarea here; content is managed via the block editor.
     *
     * @since	1.8.1
     *
